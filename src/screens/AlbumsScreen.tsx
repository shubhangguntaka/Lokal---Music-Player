...
const AlbumsScreen: React.FC<AlbumDetailScreenProps> = ({
	...
	const albumOptionActions: OptionSheetAction[] = [
		{
			key: 'play',
			label: 'Play',
			onPress: () => {
		...
		},
		{
			...
			label: 'Share',
			onPress: () => {
				void Share.share({ message: `${albumTitle} by ${artist}` });
			},
		},
	];
	...
	const optionActions = selectedOptionSong ? songOptionActions(selectedOptionSong) : albumOptionActions;
		...
		<SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}> 
			...
			<ScrollView showsVerticalScrollIndicator={false} style={styles.content}>
				...
				<View style={styles.imageContainer}>
					<Image source={albumImage} style={[styles.albumImage, { backgroundColor: theme.imagePlaceholder }]} />
				</View>

				{/* Album Info */}
				<Text style={[styles.albumTitle, { color: theme.text }]}>{albumTitle}</Text>
				<Text style={[styles.albumMeta, { color: theme.subText }]}>
					{artist} | {year}
				</Text>
				<Text style={[styles.albumStats, { color: theme.subText }]}> 
			...
			<OptionsSheetModal
				...
				title={selectedOptionSong ? selectedOptionSong.title : albumTitle}
				subtitle={
					selectedOptionSong
						? `${selectedOptionSong.artist}${selectedOptionSong.duration ? ` | ${selectedOptionSong.duration}` : ''}`
						: `${artist} | ${year}`
				}
				image={selectedOptionSong ? selectedOptionSong.image : albumImage}
